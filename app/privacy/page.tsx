          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="prose prose-lg max-w-none">
              <div className="space-y-8 text-gray-700">
                <div>
                  <h2 className="text-2xl font-bold text-[#303030] mb-4">1. Introduction</h2>
                  <p className="mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-[#303030] mb-4">2. Data Controller</h2>
                  <p className="mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-[#303030] mb-4">3. Information We Collect</h2>
                  <h3 className="text-xl font-semibold text-[#303030] mb-3">3.1 Personal Information</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-[#303030] mb-3 mt-6">3.2 Automatically Collected Information</h3>
                  <p className="mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-[#303030] mb-4">4. How We Use Your Information</h2>
                  <p className="mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-[#303030] mb-4">5. Legal Basis for Processing</h2>
                  <p className="mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-[#303030] mb-4">6. Data Sharing and Disclosure</h2>
                  <p className="mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-[#303030] mb-4">7. Data Retention</h2>
                  <p className="mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-[#303030] mb-4">8. Your Rights Under GDPR</h2>
                  <p className="mb-4">
                  ...
                  <p className="mb-4">
                    To exercise these rights, please contact us at: <a href="mailto:razvanblaga10@gmail.com" className="text-[#303030] hover:underline">razvanblaga10@gmail.com</a>
                  </p>
                </div>

                <div>
                  <h2 className="text-2xl font-bold text-[#303030] mb-4">9. Data Security</h2>
                  <p className="mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-[#303030] mb-4">10. Cookies and Tracking Technologies</h2>
                  <p className="mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-[#303030] mb-4">11. International Data Transfers</h2>
                  <p className="mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-[#303030] mb-4">12. Children's Privacy</h2>
                  <p className="mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-[#303030] mb-4">13. Changes to This Privacy Policy</h2>
                  <p className="mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-[#303030] mb-4">14. Contact Information</h2>
                  <p className="mb-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg border border-[#505050]">
                    ...
                    <p className="mt-4">
                      ...
                      Website: <a href="https://www.dataprotection.ro" target="_blank" rel="noopener noreferrer" className="text-[#303030] hover:underline">www.dataprotection.ro</a>
                    </p>
                  </div>
                </div>
              </div>
